...
<div id="Our_Services">
                            ...
                            <div id="Host_Table">
                                ...
                                <div class="Table_bottom">
                                    <ul>
                                        <li><a href="{{url('/Sups/sup_monthly')}}" class="right">اطلب الان</a></li>
                                        <li><a href="{{url('/Sups/sup_monthly')}}" class="left">اطلب الان</a></li>
                                    </ul>
                                </div>
                                <!--/bottom-->
        ...
        يسهل عملية الدخول لمدة شهر او سنة وبسعر اقل للطلاب</li>
                                    ...
                                    <div class="center_bottom"><a href="{{url('/Sups/sup_monthly')}}">اطلب الان</a></div>
                                </div>
                                <!--/Host_Center-->
